...
import { IconArrowBackUp, IconClock, IconFileText, IconLayoutDashboard, IconMenu2, IconSettings, IconUsers } from '@tabler/icons-react';
...
const navigation = [
  ...
  { name: 'Verfügbarkeit', href: '/verfuegbarkeit', icon: IconFileText },
  { name: 'Mitarbeiter', href: '/mitarbeiter', icon: IconUsers },
  { name: 'Schichtzuweisungen', href: '/schichtzuweisungen', icon: IconClock },
  { name: 'Schichtvorlagen', href: '/schichtvorlagen', icon: IconClock },
];

const externalNavigation = [
  { name: 'Verfügbarkeit', href: '/gateway/apps/6985aa67b478880a8049480b?template=list_page', icon: IconFileText },
  { name: 'Mitarbeiter', href: '/gateway/apps/6985aa61af35c01ef651189d?template=list_page', icon: IconUsers },
  { name: 'Schichtzuweisungen', href: '/gateway/apps/6985aa687b878d5fa3c976b9?template=list_page', icon: IconClock },
  { name: 'Schichtvorlagen', href: '/gateway/apps/6985aa67d601784e5e3d3fdf?template=list_page', icon: IconClock },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/6985aa67b478880a8049480b?template=list_page"
