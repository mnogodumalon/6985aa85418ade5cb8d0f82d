...
export function SchichtvorlagenDialog({ open, onClose, onSubmit, defaultValues, enablePhotoScan = false }: SchichtvorlagenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await onSubmit(fields as Schichtvorlagen['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{defaultValues ? 'Schichtvorlagen bearbeiten' : 'Schichtvorlagen hinzufügen'}</DialogTitle>
        </DialogHeader>
