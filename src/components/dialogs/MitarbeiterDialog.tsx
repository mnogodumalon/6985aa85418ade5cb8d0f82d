      ...
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="mitarbeiternummer">Mitarbeiternummer</Label>
            <Input
              id="mitarbeiternummer"
              value={fields.mitarbeiternummer ?? ''}
              onChange={e => setFields(f => ({ ...f, mitarbeiternummer: e.target.value }))}
            />
          </div>
          <div className="space-y-2">
