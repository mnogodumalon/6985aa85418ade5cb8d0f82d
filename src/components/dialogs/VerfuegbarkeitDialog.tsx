...
export function VerfuegbarkeitDialog({ open, onClose, onSubmit, defaultValues, mitarbeiterList, enablePhotoScan = false }: VerfuegbarkeitDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      await onSubmit(fields as Verfuegbarkeit['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  async function handlePhotoScan(file: File) {
    ...
    try {
      ...
      const schema = `{\n  "mitarbeiter": string | null, // Vor- und Nachname (z.B. "Jonas Schmidt")\n  "von_datum": string | null, // YYYY-MM-DD // Verfügbar von\n  "bis_datum": string | null, // YYYY-MM-DD // Verfügbar bis\n  "verfuegbarkeitsstatus": "eingeschraenkt_verfuegbar" | "verfuegbar" | "nicht_verfuegbar" | null, // Status\n  "notizen": string | null, // Notizen\n}`;
  ...
  return (
    <Dialog open={open} onOpenChange={v => !v && onClose()}>
      <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{defaultValues ? 'Verfügbarkeit bearbeiten' : 'Verfügbarkeit hinzufügen'}</DialogTitle>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={v => setFields(f => ({ ...f, verfuegbarkeitsstatus: v === 'none' ? undefined : v as 'eingeschraenkt_verfuegbar' | 'verfuegbar' | 'nicht_verfuegbar' }))}
            >
