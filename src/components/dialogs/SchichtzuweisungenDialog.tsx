...
export function SchichtzuweisungenDialog({ open, onClose, onSubmit, defaultValues, mitarbeiterList, schichtvorlagenList, enablePhotoScan = true, enablePhotoLocation = true }: SchichtzuweisungenDialogProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSaving(true);
    try {
      const clean = cleanFieldsForApi({ ...fields }, 'schichtzuweisungen');
      await onSubmit(clean as Schichtzuweisungen['fields']);
      onClose();
    } finally {
      setSaving(false);
    }
  ...
  const DIALOG_INTENT = defaultValues ? 'Schichtzuweisungen bearbeiten' : 'Schichtzuweisungen hinzufügen';
