...
import { IconAlertCircle, IconChevronLeft, IconChevronRight, IconPlus, IconTrash, IconCalendar, IconUsers, IconClock, IconCircleCheck } from '@tabler/icons-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <StatCard
          ...
          icon={<IconClock size={18} stroke={1.5} className="text-muted-foreground" />}
        />
      </div>
                      ...
                      return (
                        ...
                        >
                          ...
                          {avail && assignments.length === 0 && (
                            <div className={`text-[10px] px-1.5 py-0.5 rounded-full border mb-1 text-center ${STATUS_COLORS[avail as unknown as string] ?? ''}`}>
                              {STATUS_LABELS[avail as unknown as string] ?? String(avail)}
                            </div>
                          )}
