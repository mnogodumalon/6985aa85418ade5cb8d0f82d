...
export default function SchichtzuweisungenPage() {
  ...
  function getSchichtvorlagenDisplayName(url?: string) {
    if (!url) return '—';
    const id = extractRecordId(url);
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead>Schichtvorlage</TableHead>
              <TableHead>Datum</TableHead>
              <TableHead>Tatsächliche Startzeit</TableHead>
              <TableHead>Tatsächliche Endzeit</TableHead>
          ...
          <TableBody>
            {filtered.map(record => (
              <TableRow key={record.record_id} className="hover:bg-muted/50 transition-colors">
                ...
                <TableCell>{getSchichtvorlagenDisplayName(record.fields.schichtvorlage)}</TableCell>
